defmodule Scrumex.ProjectPriority do
  ...
  schema "project_priorities" do
    field :name, :string
    field :position, :integer

    belongs_to :project, Project
    has_many :tasks, Task, foreign_key: :priority_id
  end
  ...
  defp calculate_position(changeset) do
    if changeset.valid? do
      ...
      query = from(pp in Scrumex.ProjectPriority,
        select: pp.position,
        where: pp.project_id == ^project_id,
        order_by: [desc: pp.position],
        limit: 1)
